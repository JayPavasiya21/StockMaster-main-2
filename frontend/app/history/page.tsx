          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-end">
              <button
                ...
                className="px-4 py-2 text-sm text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-all duration-200 hover:shadow-sm"
              >
                Clear Filters
              </button>
            </div>
              ...
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="text-left p-4 text-sm font-semibold text-gray-700">Bin</th>
                    <th className="text-left p-4 text-sm font-semibold text-gray-700">Document #</th>
                    <th className="text-right p-4 text-sm font-semibold text-gray-700">Quantity</th>
                    <th className="text-right p-4 text-sm font-semibold text-gray-700">Balance</th>
                    <th className="text-left p-4 text-sm font-semibold text-gray-700">Reference</th>
                  </tr>
                </thead>
                <tbody>
                  {ledger.length === 0 ? (
                    ...
                    ledger.map((entry) => (
                      ...
                      >
                        ...
                        <td className="p-4 text-sm text-gray-600">{entry.warehouse_name}</td>
                        <td className="p-4 text-sm text-gray-600">{entry.bin_code || '-'}</td>
                        <td className="p-4 text-sm font-mono text-gray-700">{entry.document_number}</td>
