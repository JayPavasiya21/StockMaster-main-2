              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left p-3 text-sm font-medium text-gray-700">Disposition</th>
                ...
                <tbody>
                  {returns.length === 0 ? (
                    ...
                    returns.map((ret) => (
                      <tr key={ret.id} className="border-b hover:bg-gray-50 hover:shadow-sm transition-all duration-200 cursor-pointer">
