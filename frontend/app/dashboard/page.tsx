    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          ...
          <div className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-indigo-500 via-sky-500 to-emerald-500 px-4 py-1.5 text-xs font-medium text-white shadow-sm">
            <Sparkles size={16} className="animate-pulse" />
            <span>Next‑Gen Dashboard Preview</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div className="p-5 space-y-4">
              <div className="flex flex-wrap gap-2 text-[11px] text-slate-500">
                <span className="inline-flex items-center gap-1 rounded-full bg-slate-100 px-2 py-0.5">
                  <Activity size={12} /> Why are stockouts up this week?
                </span>
                <span className="inline-flex items-center gap-1 rounded-full bg-slate-100 px-2 py-0.5">
                  <Brain size={12} /> What if I cut safety stock by 10%?
                </span>
                <span className="inline-flex items-center gap-1 rounded-full bg-slate-100 px-2 py-0.5">
                  <Clock size={12} /> Which orders are at SLA risk today?
                </span>
              </div>
              <div className="flex flex-col gap-2">
                <div className="flex rounded-xl border border-slate-200 bg-slate-50/80 px-3 py-2 text-xs text-slate-500">
                  <span className="mr-1 font-semibold text-slate-600">Preview ·</span>
                  StockInfo-AI currently runs purely in the browser as a UX preview. Wire it to your AI
                  or analytics backend when you are ready.
                </div>
                <div className="flex gap-2">
                  <textarea
                    value={aiQuestion}
                    onChange={(e) => setAiQuestion(e.target.value)}
                    placeholder='Ask things like "Why are my stockouts up this week?" or "What happens if I cut safety stock by 10%?"'
                    className="flex-1 min-h-[80px] resize-none rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                  />
                </div>
                <div className="flex items-center justify-between gap-3">
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-full bg-indigo-600 px-4 py-1.5 text-xs font-medium text-white shadow hover:bg-indigo-700 disabled:cursor-not-allowed disabled:bg-slate-300"
                  >
                    {aiThinking ? (
                      <>
                    ...
                    <p className="text-[11px] text-slate-400">
                      Responses are heuristic for now — plug StockInfo-AI into your AI service to go fully live.
                    </p>
                </div>
              </div>
              {aiAnswer && (
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl bg-white shadow border border-slate-100/80 p-4 space-y-3">
              ...
              <button className="mt-1 inline-flex items-center gap-1 text-[11px] font-medium text-indigo-600 hover:text-indigo-700">
                <Workflow size={12} />
        ...
        <div className="grid grid-cols-1 2xl:grid-cols-3 gap-6">
          ...
          <div className="2xl:col-span-2 bg-white rounded-2xl shadow border border-slate-100/80 p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <Clock size={18} className="text-slate-500" />
                <h2 className="text-lg font-semibold text-gray-900">Real‑Time Flow Timeline</h2>
              </div>
              <p className="text-xs text-slate-500">Today · inbound, outbound, transfers & issues</p>
            </div>
          ...
          {/* Workforce Snapshot */}
          <div className="space-y-4">
            <div className="bg-white rounded-2xl shadow border border-slate-100/80 p-4">
              <div className="mb-3 flex items-center gap-2">
                <UserGroupIcon />
                <h2 className="text-sm font-semibold text-gray-900">Workforce & Equipment Utilization</h2>
              </div>
